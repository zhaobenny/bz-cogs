...
Usage:
    uv run aiuser/utils/update_models.py
"""
...
OUTPUT_FILE = Path(__file__).parent.parent / "config" / "models.py"
OVERRIDES_FILE = Path(__file__).parent.parent / "config" / "models_overrides.py"
...
def generate_models_file(
    ...
    return f"""# Auto-generated by aiuser/utils/update_models.py
