...
Convert the below message to an Art Prompt. The prompt Should not have line breaks, No close-up *unless instructed, No dots, No delimiters.
keep the prompt as short as possible. Each tag should be no more than 4 words. avoid using articles.
DO NOT MEANTION photographing/capturing of someone or something.
