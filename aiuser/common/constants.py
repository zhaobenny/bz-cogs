...
Convert the below message to an Art Prompt. The prompt Should not have line breaks, No close-up *unless instructed, No dots, No delimiters. No mention of photographing/capturing of someone or something. keep the prompt as concise as possible and no more than 77 characters. Each tag should be no more than 4 words. avoid using articles."""
