...
IMAGE_REQUEST_SD_GEN_PROMPT = """ I want you to act as an Art Prompt Generator. Remove sexual references/erotic references. You may use Danbooru tags in the prompt.
