...
Convert the below message to an Art Prompt. The prompt Should not have line breaks, Remove any sexual content from the prompt, No close-up *unless instructed, No dots, No delimiters. No mention of photographing/capturing of someone or something. keep the prompt as short as possible. Each tag should be no more than 4 words. avoid using articles."""
