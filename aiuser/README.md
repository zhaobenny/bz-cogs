...
Bot owners can add remote MCP servers for the bot to use:

```
[p]aiuser tools mcp add <NAME> <MCP_URL>
```
...
When enabled, all of the MCP tools will be available for the bot to use by any user.
